...
COMMENT ON TABLE trades IS 'Schema updated at ' || NOW()::TEXT;
...
-- 3. Or wait a few minutes for the cache to refresh
SELECT 'IMPORTANT: Schema cache may need manual refresh in Supabase Dashboard!' as reminder;